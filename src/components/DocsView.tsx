  ...
  return (
    <div className="w-full flex flex-col h-[calc(100vh-180px)] max-w-md mx-auto relative px-2">
      ...
      <div className="flex-1 overflow-y-auto pr-1 pb-6 space-y-4 scrollbar-thin scrollbar-thumb-zinc-800">
        <div className="space-y-4 animate-fade-in text-zinc-200 text-sm sm:text-base">
          ...
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md">
            ...
            <div className="mt-3 p-3 bg-zinc-950/80 rounded-xl border border-zinc-800/50 text-sm sm:text-base space-y-1.5 text-zinc-300">
          ...
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md">
            ...
            <div className="space-y-2 text-zinc-300 leading-relaxed text-sm sm:text-base">
              <p>
              ...
              <div className="mt-3 p-3 bg-zinc-950/80 rounded-xl border border-zinc-800/50 text-xs sm:text-sm space-y-1.5 text-zinc-300">
          ...
          <div className="p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-md space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm sm:text-base text-zinc-300 pl-3.5 leading-normal">
          ...
          {/* About / Credits */}
          <div className="p-4 rounded-2xl bg-zinc-900/40 border border-zinc-800/60 backdrop-blur-md flex items-start gap-3 text-zinc-300 text-sm sm:text-base leading-relaxed">
