 ...
 * @description Symmetrical, premium generator component for Scénarios, Catégories, Thèmes, and Échauffements.
 * Features a spinning animation, category tags, and clean layout with modern micro-animations.
 */
...
interface GenericGeneratorProps {
  categoryKey: "scenarios" | "categories" | "themes" | "echauffements";
  title: string;
  pickItem: (category: "scenarios" | "categories" | "themes" | "echauffements") => any;
        ...
        <div className="generator-card-inner min-h-[200px] flex flex-col justify-center items-center p-6">
          <div className={`transition-all duration-300 flex flex-col items-center text-center w-full ${isSpinning ? "scale-95 blur-sm opacity-50" : "scale-100 opacity-100"}`}>
            ...
            <h4 className="text-2xl font-extrabold tracking-tight text-white mb-3">
              {currentItem ? currentItem.title : "Réservoir vide..."}
            </h4>
