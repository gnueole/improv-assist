...
# License: MIT
#
# Queries GitHub Actions API to check latest build/run status for the HoubaHouba (Improv Assist) subproject.
# ==============================================================================
...
def check_build():
    ...
    url = "https://api.github.com/repos/gnueole/improv-assist/actions/runs?branch=main"
